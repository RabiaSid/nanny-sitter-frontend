    ...
    >
      <div className="container mx-auto">
        ...
        >
          <div className="grid md:grid-cols-2 md:gap-6">
            ...
            <div className="relative z-0 w-full mb-5 group">
              <input
                ...
                className="block py-4 my-2 px-0 w-full text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-gray-500 focus:outline-none focus:ring-0 focus:border-gray-600 peer"
                placeholder=" "
                required
              />
              <label
          ...
          <button
            type="submit"
            className="text-white bg-gray-950 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-lg w-full sm:w-auto px-5 py-4 my-2 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
