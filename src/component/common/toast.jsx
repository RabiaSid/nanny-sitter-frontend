...
export default function Toast({ message, type, isVisible, onClose }) {
    ...
    return (
        <div className={`absolute z-50 mx-auto top-[15px] left-[35%] right-[35%] flex items-center w-full max-w-xs p-4 mb-4 ${textColor} ${bgColor} rounded-lg shadow`} role="alert">
