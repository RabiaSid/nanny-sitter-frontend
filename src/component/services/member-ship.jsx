    ...
    return (
        <div className="py-[30px] md:py-[50px] lg:py-[100px]">
            ...
            <div className="container mx-auto group">
                ...
                <H2 className="font-creato mb-4 text-center capitalize">{data.title}</H2>
                <Font2 className="text-[#333333]text-opacity-80 text-center">{data.content}</Font2>
                <div className="embla my-8">
                    <div className="embla__viewport my-8" ref={emblaRef} options={OPTIONS}>
                ...
                <div className='flex flex-col justify-center items-center'>
                    <button className="px-10 py-3 mb-4 bg-[#609FC6] text-white font-medium rounded-[25px]  ">Learn More</button>
                </div>
            </div>
