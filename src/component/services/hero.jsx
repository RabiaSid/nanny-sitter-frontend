            ...
            <div className="container mx-auto p-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-8">
                    <div className="mb-4 ">
                        ...
                        <Font1 className="font-montserrat text-[#666666] py-2 border-b border-gray-300">{data.content}</Font1>
                        <Font1 className="font-montserrat text-[#666666] py-2">{data.content2}</Font1>
                    </div>
                    <div className=''>
