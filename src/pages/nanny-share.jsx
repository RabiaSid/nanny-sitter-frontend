...
export default function NannyShare() {
    const HeroData = {
        Img: HeroImgBG,
        title: (<>Share your nanny <br className='hidden lg:block' /> with another family</>),
        content: (<>Split the cost of a nanny and enjoy flexible child <br className='hidden lg:block' />  care with a nanny share.</>)
    }

    const TwoWayData = {
        title: (<>The most common ways to<br /> set up your nanny share</>)
    }
    const TwoWayList = [
        {
            img: TwoWayImg1,
            title: "Your nanny watches both families’ kids together",
            description: "You can have a nanny that watches both kids together at one of your homes."
        },
        {
            img: TwoWayImg2,
            title: "Your nanny splits time between two families",
            description: "You can split your nanny’s hours with another family to fit around your schedule."
        },
    ];
    ...
    const contractData = {
        title: (<>Why a nanny share is the<br /> right choice for your family</>)
    }
    ...
    const CtaData = {
        bgImg: ctaImgBG,
        Img: ctaImg,
        title: (<>Make more time for <br className='hidden md:block' />what matters with our<br className='hidden md:block' /> payroll service </>),
        content: (<>Send us your shared and individual hours, the negotiated  <br className='hidden lg:block' />rates, and we’ll take care of all your payroll needs.</>)
    }

    const FindData = {
        title: (<>Tips on how to manage your <strong className='text-[#FF6F61]'>nanny</strong></>),
        icon1: findImg1,
