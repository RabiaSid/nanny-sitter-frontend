...
const HeroData = {
    ...
    content: (<>PLUS membership gives you access to premium features like hiring assistance, a featured profile, candidate tracking, background checks, and a nanny payroll service!</>),
    content2: (<>PLUS is not yet available in your area. We’re working hard to bring these features to you soon. Check back for updates!</>)
}
