...
const HeroData = {
    ...
    content2: (<>Nanny contracts are not yet available in your area. We’re working hard to bring these features to you soon. Check back for updates!</>)
}
...
const contractList = [
    ...
    },
    {
        ...
        description: "Whenever you’re ready, you can always preview your nanny contract.",
    },
    {
        img1: ContractIcon1,
        img2: ContractIcon2,
        title: "Add to your nanny contract",
        description: (<>Whether you have a full-time, part-time, or live-in, use your <br />nanny contract template as a guide.</>),
    },
    {
        img1: ContractIcon1,
        img2: ContractIcon2,
        title: "Make it official with a contract",
        description: "Save your nanny contract & share your contract with your nanny.",
    },
];
    ...
    desc: [
        {
            ...
            desc: (<>Make sure you & your nanny are on the same page with a nanny agreement.</>)
        },
        {
            title: "Balance the personal and professional",
            desc: (<>Keep the parent-nanny relationship simple by setting boundaries with a nanny contract.</>)
        },
        {
