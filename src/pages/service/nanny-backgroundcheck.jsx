...
const HeroData = {
    ...
    content: (<>Childcare is a serious business. Ensure your kids are in good hands with our nanny background check service.</>),
    content2: (<>Background checks are not yet available in your area. We’re working hard to bring these features to you soon. Check back for updates!</>)
}
...
const TwoWayData = {
    title: (<>The two ways to run a nanny<br /> background check</>)
}
const TwoWayList = [
    {
        img: TwoWayImg1,
        title: "Run a background check",
        description: "Your nanny provides their information and you’ll get the results once the background check is complete."
    },
    {
        img: TwoWayImg2,
        title: "Finalize hiring your nanny with PLUS",
        description: "From background checks to handling payments and taxes, we’re here at every step of the way"
    },
];
...
const MemberShipData = {
    ...
    content: (<>From background checks to handling payments, we’ve got services you can access whenever you need them.</>),
}
    ...
    desc: [
        {
            ...
            desc: (<>Be sure your family receives the care they need by someone you can trust.</>)
        },
        {
        ...
        {
            title: "Peace of mind",
            desc: (<>Enjoy the peace of mind in your decision to hire a nanny for a small cost.</>)
        },
    ]
}

const FaqContent = {
    title: (<>Frequently asked questions about background checks</>)
}
