...
const HeroData = {
    ...
    content: (<>We make payroll processing, withholdings and nanny tax filing easy</>),
    content2: (<>Payroll services are not yet available in your area. We’re working hard to bring these features to you soon. Check back for updates!</>)
}
...
const CtaData = {
    bgImg: ctaImgBG,
    Img: ctaImg,
    title: (<>Nanny payroll services <br className='hidden md:block' /> for multiple families</>),
    content: (<>Payroll is complicated, especially when two families <br className='hidden lg:block' /> are involved. We handle payroll for nanny share<br className='hidden lg:block' />  families.</>),
...
const QuestionList = [
    {
        icon1: questionImg1,
        icon2: questionImg2,
        title: (<>What is the cost of Top <br className='hidden md:block' /> Nanny Sitter Payroll?</>),
    ...
    },
    {
        icon1: questionImg1,
        icon2: questionImg2,
        title: (<>Is Top Nanny Sitter Payroll <br className='hidden md:block' /> offered in all states?</>),
