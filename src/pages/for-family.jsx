...
const HeroData = {
  ...
  title: (
    <>
      Reliable <span className="text-[#FF6F61]">Babysitting</span>
...
const PointsData = {
  ...
  title: (
    <>
      ...
      <span className="text-[#FF6F61]">families and nannies love</span>
...
const ProcessData = {
  title: (
    <>
      <strong className="text-[#FF6F61]">We’re here</strong> for you at every{" "}
...
const MemberServiceData = {
  title: (
    <>
      Complete <strong className="text-[#FF6F61]">your nanny</strong> search
...
const NeedData = {
  title: (
    <>
      Find a <strong className="text-[#FF6F61]">nanny</strong> that becomes part
      of your family
    </>
  ),
  content: (
...
const FindData = {
  title: (
    <>
      Tips on how to find a <strong className="text-[#FF6F61]">nanny</strong>
    </>
  ),
  icon1: findImg1,
